...
def mock_drinks_api():
    ...
    """
    return [
        {"name": "Coffee", "ingredients": ["coffee", "milk"]},
        {"name": "Tea", "ingredients": ["tea", "milk"]},
        {"name": "Cappuccino", "ingredients": ["coffee", "milk", "sugar"]},
    ]
...
def mock_get_all_drinks_containing_ingredient(monkeypatch):
    def mock_get_all_drinks_containing_ingredient_func(available_ingredient):
        ...
        drinks_list = [
            ...
            if available_ingredient in drink["ingredients"]
        ]
        return drinks_list
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ["sugar", "tea"],
            ["Cappuccino", "Tea"],
        ),  # Cappuccino and Tea only drinks which contain one of these ingredients
    ],
)
def test_get_all_drinks_containing_ingredient(
    mock_get_all_drinks_containing_ingredient, test_ingredients, expected
):
    """
